...
void write_list(char * fname, list * plst); // функция записывает элементы списка в файл;
list * read_list(char * fname); // функция читает значения элементов из файла и создает список;
